...
class DriverModel extends BaseUser {
  ...
  final List<Map<String, dynamic>> usualRoutes; // [{route: "North Campus - Mandi", price: "900-1000"}]
  ...
  factory DriverModel.fromMap(Map<String, dynamic> map, String uid) {
    return DriverModel(
      ...
      usualRoutes: map['usualRoutes'] != null
          ? List<Map<String, dynamic>>.from(
              (map['usualRoutes'] as List).map((e) => Map<String, dynamic>.from(e)))
          : [],
      createdAt:
          map['createdAt'] != null ? DateTime.parse(map['createdAt']) : null,
      profileImageUrl: map['profileImageUrl'],
  ...
  DriverModel copyWith({
    ...
    int? seatsAvailable,
    bool? isAvailable,
    List<Map<String, dynamic>>? usualRoutes,
    double? rating,
    int? totalRides,
    DateTime? createdAt,
  ...
  @override
  String toString() {
    return 'DriverModel(uid: $uid, fullName: $fullName, vehicle: $vehicleModel, rating: $rating, isAvailable: $isAvailable)';
  }
}
