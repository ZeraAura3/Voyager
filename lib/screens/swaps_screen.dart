  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppLocalizations.of(context)!.trades,
          style: TextStyle(
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  AppLocalizations.of(context)!.browseOrPostTrades,
                  style: TextStyle(
                    fontSize: 14,
                ...
                Row(
                  children: [
                    _buildTabButton(AppLocalizations.of(context)!.browseTrades, 0),
                    const SizedBox(width: 12),
                    _buildTabButton(AppLocalizations.of(context)!.postTrade, 1),
                  ],
                ),
              ],
            ),
...
class _BrowseSwapsTabState extends State<BrowseSwapsTab> {
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                _buildFilterChip(AppLocalizations.of(context)!.buy, 'buy'),
                const SizedBox(width: 8),
                _buildFilterChip(AppLocalizations.of(context)!.sell, 'sell'),
                const SizedBox(width: 8),
                _buildFilterChip(AppLocalizations.of(context)!.swap, 'swap'),
              ],
            ),
          ),
        ),
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppLocalizations.of(context)!.beFirstToPostTicket,
                  ...
                  children: [
                      ...
                      Chip(
                        label: Text(
                          ticket.tradeType == 'buy'
                              ? AppLocalizations.of(context)!.lookingToBuy
                              : AppLocalizations.of(context)!.lookingToSwap,
                    ...
                    if (!isOwnTicket)
                      ElevatedButton(
                        ...
                        child: Text(AppLocalizations.of(context)!.requestAction),
                      )
                    else
                      IconButton(
                        ...
                        tooltip: AppLocalizations.of(context)!.deleteTicket,
                      ),
                  ],
                ),
  ...
  void _confirmDeleteTicket(TicketModel ticket) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            AppLocalizations.of(context)!.deleteTicketConfirm),
        actions: [
          TextButton(
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context)!.ticketDeletedSuccess),
            backgroundColor: const Color(0xFF00B25E),
          ),
        );
      }
  ...
  void _showSwapRequestDialog(TicketModel ticket) {
    ...
    if (currentUser == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppLocalizations.of(context)!.pleaseLoginToSendRequests)),
      );
      return;
    }
    ...
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(AppLocalizations.of(context)!.sendSwapRequest),
        content: Column(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(AppLocalizations.of(context)!.sendSwapRequest),
          ),
        ],
      ),
    );
...
class _PostSwapTabState extends State<PostSwapTab> {
    ...
    return SingleChildScrollView(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context)!.postYourTicket,
              style: TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold,
                color: Theme.of(context).textTheme.titleLarge?.color,
            ...
            Row(
              children: [
                _buildTradeTypeChip(AppLocalizations.of(context)!.buy, 'buy'),
                const SizedBox(width: 8),
                _buildTradeTypeChip(AppLocalizations.of(context)!.sell, 'sell'),
                const SizedBox(width: 8),
                _buildTradeTypeChip(AppLocalizations.of(context)!.swap, 'swap'),
              ],
            ),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: _isPriceFixed
                      ? AppLocalizations.of(context)!.fixedPriceRoute
                      : AppLocalizations.of(context)!.enterPrice,
                  helperText: _isPriceFixed
                      ? AppLocalizations.of(context)!.fixedPriceHint
                      : AppLocalizations.of(context)!.customPriceHint,
                  helperMaxLines: 2,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading
                    ...
                    : Text(
                        AppLocalizations.of(context)!.postTicket,
                        style: const TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                        ),
  ...
  Future<void> _submitTicket() async {
    ...
    if (_selectedImage == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context)!.uploadTicketImage),
          backgroundColor: Colors.red,
        ),
      );
      return;
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context)!.ticketPostedSuccess),
            backgroundColor: const Color(0xFF00B25E),
          ),
        );
