                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              colors: [Color(0xFF00B25E), Color(0xFF2DD07A)],
                            ),
                        ...
                        Text(
                          AppLocalizations.of(context)!.rideShare,
                          style: TextStyle(
                            fontSize: 28,
                        ...
                        Text(
                          AppLocalizations.of(context)!.shareRidesSaveMoney,
                          style: TextStyle(
                            fontSize: 14,
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              child: Text(AppLocalizations.of(context)!.forgotPassword,
                                  style: const TextStyle(color: Color(0xFF00B25E))),
                            ),
                          ],
                        ),
                        const SizedBox(height: 12),
